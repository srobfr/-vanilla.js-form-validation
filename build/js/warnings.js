...
function createBubble(text) {
    // creates a popup bubble that shows up after failed validaiton
    var bubble = document.createElement('div');
    var parent = document.getElementById("bubble_holder");
...
function createWarning(field, warning, limit) {
    // pops up a message about excessive amount of accepted signs in a field
    var box = document.getElementsByName(field)[0].value;
    var textWarning1 = document.getElementById(warning);
    if (box.length > limit) {
